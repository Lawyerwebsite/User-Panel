    ...
    <div className="relative w-full h-64">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h1 className="text-white text-xl text-center px-4">
            To maintain the sanctity of the judicial process, ensuring that the judiciary's authority is respected and upheld.
          </h1>
        </div>
      </div>
    ...
    <div className="w-full max-w-7xl p-8 mt-20 mb-8 sm:w-11/12 sm:h-auto bg-white shadow-xl rounded-lg mx-auto ">
      ...
      <div className="p-6">
        <h2 className="font-bold text-2xl mb-4 text-center">
          Madras High Court Reiterates the Scope of Review
        </h2>
        <p className="text-gray-700 mb-4">
          Civil contempt refers to the willful disobedience of an order of any court. Criminal contempt includes any act or publication which:
        </p>
