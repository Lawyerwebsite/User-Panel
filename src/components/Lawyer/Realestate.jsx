       ...
       <div>
        <NavbarComp/>
         <div className="w-full max-w-7xl p-8 mt-[100px] border mb-8 sm:w-11/12 sm:h-auto bg-white shadow-xl rounded-lg mx-auto flex justify-evenly">
            <div >
                <h1 className='font-bold text-3xl'>Dorothy F. Easley</h1>
            ...
            <div className='w-full m-4'>
                <img  className="rounded-2xl" src="https://t3.ftcdn.net/jpg/07/46/68/02/360_F_746680247_Kz9hbebxNjKyTVu4NLDOUQyrhlOv7NGW.jpg"/>
            </div>
        </div>
        <Footer/>
       </div>
...
export default RealestateLawyer;
