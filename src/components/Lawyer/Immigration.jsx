...
const ImmigrationLawyer = () => {
    return (
        <div>
            ...
            <div >
                <h1 className='font-bold text-3xl'>Peter Prieto</h1>
            ...
            <div className='w-full m-4'>
                <img  className="rounded-2xl" src="https://ayjsolicitors.com/wp-content/uploads/2021/03/profile-info-img.jpg"/>
            </div>
        </div>
        <Footer/>
        </div>
...
export default ImmigrationLawyer;
